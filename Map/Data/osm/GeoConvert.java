//Denne klasse er hentet fra: https://github.com/Jotschi/geoconvert/blob/master/src/main/java/de/jotschi/geoconvert/GeoConvert.java
//
//og mildt ændret, så den ikke behøver at bruge tid på at finde, zonen, da alle DK's punkter er i zone 32.
...
public class GeoConvert {
	...
	public static double[] toUtm(double lon, double lat) throws Exception {
		...
		int zone = 32;/*(int) Math.floor((lon + 180.0) / 6) + 1;*/
