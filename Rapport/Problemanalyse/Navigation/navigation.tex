...
\begin{figure}[h]
  	\centering
    \includegraphics[width=0.8\textwidth]{dijkstra1}
	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h]
  	\centering
    \includegraphics[width=0.8\textwidth]{dijkstra2}
	\caption{A picture of a gull.}
\end{figure}
...
\begin{figure}[h]
  	\centering
    \includegraphics[width=0.8\textwidth]{astar1}
	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h]
  	\centering
    \includegraphics[width=0.8\textwidth]{astar2}
	\caption{A picture of a gull.}
\end{figure}
