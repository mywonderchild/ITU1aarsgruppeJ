...
public class TestShortestPath {
	...
	public void setup() {
		...
		Edge[] edges = new Edge[] {
			new Edge(nodes[0], nodes[2], 6, -1, "", -1, -1),
			new Edge(nodes[0], nodes[3], 3, -1, "", -1, -1),
			new Edge(nodes[1], nodes[0], 3, -1, "", -1, -1),
			new Edge(nodes[2], nodes[3], 2, -1, "", -1, -1),
			new Edge(nodes[3], nodes[1], 1, -1, "", -1, -1),
			new Edge(nodes[3], nodes[2], 1, -1, "", -1, -1),
			new Edge(nodes[4], nodes[1], 4, -1, "", -1, -1),
			new Edge(nodes[4], nodes[3], 2, -1, "", -1, -1),
		};
